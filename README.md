...
## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/rainhitgrassed/awdasdadad/main/UI')))()
```
...
Tab:AddColorpicker({
	Name = "Colorpicker",
	Default = Color3.fromRGB(164, 20, 174),
	Callback = function(Value)
		print(Value)
	end	  
})
...
Tab:AddSlider({
	...
	Max = 20,
	Default = 5,
	Color = Color3.fromRGB(164, 20, 174),
	Increment = 1,
	ValueName = "bananas",
	Callback = function(Value)
		print(Value)
